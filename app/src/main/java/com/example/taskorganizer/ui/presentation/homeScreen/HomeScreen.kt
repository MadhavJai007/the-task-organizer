...
import com.example.taskorganizer.data.models.FilterTypes
                            ...
                            FilterTypes.values().forEachIndexed{ index, filterType ->
                                if(filterType.category == selectedFilterCategory){
                                    Row(
                                        ...
                                        if(selectedFilterType.displayStr == filterType.displayStr){
                                            Button(onClick = {
                                                selectedFilterType = filterType
                                                homeViewModel.sortAndFilterTasks(selectedSortType, filterType)
                                            }) {
                                                Text(text = filterType.displayStr)
                                            }
                                        }
                                        else{
                        ...
                        Row(
                            ...
                            SortTypes.values().forEachIndexed{ index, sortType ->
                                Row(
                                    ...
                                    if(selectedSortType.displayStr == sortType.displayStr){
                                        Button(onClick = {
                                            selectedSortType = sortType
                                            homeViewModel.sortAndFilterTasks(sortType, selectedFilterType)
                                        }) {
                                            Text(text = sortType.displayStr)
                                        }
                                    }
                                    else{
                                        OutlinedButton(onClick = {
